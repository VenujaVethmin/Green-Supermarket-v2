    ...
    <div class="row">
        ...
        <div class="col-lg-12 main-content">
            ...
            <div>
                ...
                <button class="btn btn-danger add-products-button" onclick="toggleSidebar2('delete')">Delete Products</button>
            </div>
            ...
            <div class="sidebar" id="sidebar1">
                ...
                <div class="sidebar-content">
                    ...
                    <form action="AddProduct" method="get">
                        ...
                        <input type="text" class="form-control" id="productName1" placeholder="Name" name="name">
